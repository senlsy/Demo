        ...
        mAdapter.setOnClickListener(object : EffectListAdapter.OnCallBack {
            ...
            override fun onClick(effect: Effect, view: View) {
                ...
                when (effect.name) {
                    ...
                    "makeCustom" -> {
                        ActivityCompat.startActivity(this@AfterActivity,
                                Intent(this@AfterActivity, AfterTwoActivity::class.java).apply {
                                    putExtra("effect", effect as Serializable)

                                },
                                ActivityOptionsCompat.makeCustomAnimation(this@AfterActivity, android.R.anim.fade_in, android.R.anim.fade_out).toBundle())
                    }
