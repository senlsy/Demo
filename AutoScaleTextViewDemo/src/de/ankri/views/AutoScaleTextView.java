...
public class AutoScaleTextView extends TextView
{
	...
	{
		super(context);
		Log.e("lintest", "AutoScaleTextView(1个参数)");
		init();
	}
	...
	public AutoScaleTextView(Context context, AttributeSet attrs)
	{
		...
		// 注释super之后的代码，打开下面这句，尝试下效果吧--------------
		this(context, attrs, R.attr.autoScaleTextViewStyle);
		// 不在xml文件中指定style，直接使用view的构造函数指定的style
		// --------------------------------------
		// super(context, attrs);
		// Log.e("lintest", "AutoScaleTextView(2个参数)");
	...
	public AutoScaleTextView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		Log.e("lintest", "AutoScaleTextView(3个参数)");
